...
namespace HRM.Services.Catalog.Login
{
    public class LoginService : ILoginService
    {
        ...
        public LoginService(HRMDbContext context, IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
        {
            _context = context;
