...
namespace HRM.Services.Catalog.WorkHour
{
    public class WorkhourService : IWorkHourService
    {
        ...
        public WorkhourService(HRMDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<int> Checkout(CheckoutModel checkout)
        {
            ...
            if (whcheckout == null) throw new HRMDbException($" You {checkout.EmployeesID} dont have check in yet ");
        ...
        public async Task<int> Delete(int ID)
        {
            ...
            if (workhour == null) throw new HRMDbException($"Cannot find a product: {ID}");
