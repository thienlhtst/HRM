        ...
        public static void Seed(this ModelBuilder modelbuilder)
        {
            ...
            modelbuilder.Entity<SystemManagement>().HasData(
                ...
                new SystemManagement() { ID=1, FunctionID="100000", ParentID=null, Language=null, Layout="login", Name=null, Label=null, Description=null, KindInput=null, Icon=null, Values=null, KindSystem=KindSystem.Layout, ClassName=null, Pattern=null, PatternName=null, IsImportant=null, },
                 ...
                 new SystemManagement() { ID=66, FunctionID="NA000101", ParentID="NA000001", KindSystem=KindSystem.Label, Label="Dashboard", Language=language.en, Layout="nav-admin", Description="Nav Admin", Routes="dashboard" },
                 new SystemManagement() { ID=67, FunctionID="NA000102", ParentID="NA000001", KindSystem=KindSystem.Label, Label="Workhour's Satistic", Language=language.en, Layout="nav-admin", Description="Nav Admin", Routes="statistic/workhour" },
                 new SystemManagement() { ID=68, FunctionID="NA000103", ParentID="NA000001", KindSystem=KindSystem.Label, Label="Salary's Statistic", Language=language.en, Layout="nav-admin", Description="Nav Admin", Routes="statistic/salary" },
                 new SystemManagement() { ID=69, FunctionID="NA000104", ParentID="NA000001", KindSystem=KindSystem.Label, Label="QR test", Language=language.en, Layout="nav-admin", Description="Nav Admin", Routes="qrcode" },
                 new SystemManagement() { ID=70, FunctionID="NA000201", ParentID="NA000002", KindSystem=KindSystem.Label, Label="List Employee", Language=language.en, Layout="nav-admin", Description="Nav Admin", Routes="employee" },
                 new SystemManagement() { ID=71, FunctionID="NA000202", ParentID="NA000002", KindSystem=KindSystem.Label, Label="Position", Language=language.en, Layout="nav-admin", Description="Nav Admin", Routes="postion" },
                 new SystemManagement() { ID=72, FunctionID="NA000203", ParentID="NA000002", KindSystem=KindSystem.Label, Label="Level", Language=language.en, Layout="nav-admin", Description="Nav Admin", Routes="level" },
                 new SystemManagement() { ID=73, FunctionID="NA000204", ParentID="NA000002", KindSystem=KindSystem.Label, Label="Salary", Language=language.en, Layout="nav-admin", Description="Nav Admin", Routes="salary" },
                 new SystemManagement() { ID=74, FunctionID="NA000205", ParentID="NA000002", KindSystem=KindSystem.Label, Label="Labour Contract", Language=language.en, Layout="nav-admin", Description="Nav Admin", Routes="labourcontract" },
                 new SystemManagement() { ID=75, FunctionID="NA000301", ParentID="NA000003", KindSystem=KindSystem.Label, Label="Work Hours", Language=language.en, Layout="nav-admin", Description="Nav Admin", Routes="workhour" },
                 new SystemManagement() { ID=76, FunctionID="NA000302", ParentID="NA000003", KindSystem=KindSystem.Label, Label="Labour Day", Language=language.en, Layout="nav-admin", Description="Nav Admin", Routes="labourday" },
                 new SystemManagement() { ID=77, FunctionID="NA000401", ParentID="NA000004", KindSystem=KindSystem.Label, Label="List Allowances", Language=language.en, Layout="nav-admin", Description="Nav Admin", Routes="allowance" },
                 new SystemManagement() { ID=78, FunctionID="NA000402", ParentID="NA000004", KindSystem=KindSystem.Label, Label="Employees's Allowance", Language=language.en, Layout="nav-admin", Description="Nav Admin", Routes="ewa" },
                 new SystemManagement() { ID=79, FunctionID="NA000403", ParentID="NA000004", KindSystem=KindSystem.Label, Label="Employees's Allowance Rules", Language=language.en, Layout="nav-admin", Description="Nav Admin", Routes="allowancesemployeerules" },
                 ...
                 new SystemManagement() { ID=85, FunctionID="NA000101", ParentID="NA000001", KindSystem=KindSystem.Label, Label="Trang chủ", Language=language.vn, Layout="nav-admin", Description="Nav Admin", Routes="dashboard" },
                 new SystemManagement() { ID=86, FunctionID="NA000102", ParentID="NA000001", KindSystem=KindSystem.Label, Label="Thống kê giờ công", Language=language.vn, Layout="nav-admin", Description="Nav Admin", Routes="statistic/workhour" },
                 new SystemManagement() { ID=87, FunctionID="NA000103", ParentID="NA000001", KindSystem=KindSystem.Label, Label="Thông kê Lương", Language=language.vn, Layout="nav-admin", Description="Nav Admin", Routes="statistic/salary" },
                 new SystemManagement() { ID=88, FunctionID="NA000104", ParentID="NA000001", KindSystem=KindSystem.Label, Label="Quét mã QR", Language=language.vn, Layout="nav-admin", Description="Nav Admin", Routes="qrcode" },
                 new SystemManagement() { ID=89, FunctionID="NA000201", ParentID="NA000002", KindSystem=KindSystem.Label, Label="Danh sách nhân viên", Language=language.vn, Layout="nav-admin", Description="Nav Admin", Routes="employee" },
                 new SystemManagement() { ID=90, FunctionID="NA000202", ParentID="NA000002", KindSystem=KindSystem.Label, Label="Vị trí", Language=language.vn, Layout="nav-admin", Description="Nav Admin", Routes="postion" },
                 new SystemManagement() { ID=91, FunctionID="NA000203", ParentID="NA000002", KindSystem=KindSystem.Label, Label="Cấp bậc", Language=language.vn, Layout="nav-admin", Description="Nav Admin", Routes="level" },
                 new SystemManagement() { ID=92, FunctionID="NA000204", ParentID="NA000002", KindSystem=KindSystem.Label, Label="Lương", Language=language.vn, Layout="nav-admin", Description="Nav Admin", Routes="salary" },
                 new SystemManagement() { ID=93, FunctionID="NA000205", ParentID="NA000002", KindSystem=KindSystem.Label, Label="Hợp đồng", Language=language.vn, Layout="nav-admin", Description="Nav Admin", Routes="labourcontract" },
                 new SystemManagement() { ID=94, FunctionID="NA000301", ParentID="NA000003", KindSystem=KindSystem.Label, Label="Danh sách Giờ công", Language=language.vn, Layout="nav-admin", Description="Nav Admin", Routes="workhour" },
                 new SystemManagement() { ID=95, FunctionID="NA000302", ParentID="NA000003", KindSystem=KindSystem.Label, Label="Quản lý Ngày Làm", Language=language.vn, Layout="nav-admin", Description="Nav Admin", Routes="labourday" },
                 new SystemManagement() { ID=96, FunctionID="NA000401", ParentID="NA000004", KindSystem=KindSystem.Label, Label="Danh Sách Phụ cấp", Language=language.vn, Layout="nav-admin", Description="Nav Admin", Routes="allowance" },
                 new SystemManagement() { ID=97, FunctionID="NA000402", ParentID="NA000004", KindSystem=KindSystem.Label, Label="Phụ cấp Nhân Viên", Language=language.vn, Layout="nav-admin", Description="Nav Admin", Routes="ewa" },
                 new SystemManagement() { ID=98, FunctionID="NA000403", ParentID="NA000004", KindSystem=KindSystem.Label, Label="Luật Phụ cấp ", Language=language.vn, Layout="nav-admin", Description="Nav Admin", Routes="allowancesemployeerules" }
