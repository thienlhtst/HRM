        ...
        public static void Seed(this ModelBuilder modelbuilder)
        {
            ...
            modelbuilder.Entity<SystemManagement>().HasData(
                ...
                //nav-admin
                 ...
                 new SystemManagement() { ID = 200,FunctionID = "PI000000", ParentID = null, Language = null, Layout = "infor", Icon = null, Values = null, Description = "Infor" },
                 new SystemManagement() { ID = 201,FunctionID = "PI000001", ParentID = "PI000000", KindSystem = KindSystem.Group,Language = language.en, Label = "Basic Information",Icon = "bi bi-person-square", Layout = "infor" },
                 new SystemManagement() { ID = 202,FunctionID = "PI000002", ParentID = "PI000000", KindSystem = KindSystem.Group,Language = language.en, Label = "Position Information",Icon = "bi bi-filter-square-fill", Layout = "infor"},
                 new SystemManagement() { ID = 203,FunctionID = "PI000003", ParentID = "PI000000", KindSystem = KindSystem.Group,Language = language.en, Label = "Level Information",Icon = "bi bi-filter-square-fill", Layout = "infor"},
                 new SystemManagement() { ID = 204,FunctionID = "PI000101", ParentID = "PI000001", KindSystem = KindSystem.Label,Language = language.en, Name = "lastName",Layout="infor"},
                 new SystemManagement() { ID = 205,FunctionID = "PI000102", ParentID = "PI000001", KindSystem = KindSystem.Label,Language = language.en, Name = "email",Layout = "infor"},
                 new SystemManagement() { ID = 206,FunctionID = "PI000103", ParentID = "PI000001", KindSystem = KindSystem.Label,Language = language.en, Name = "dob",Layout = "infor"},
                 new SystemManagement() { ID = 207,FunctionID = "PI000104", ParentID = "PI000001", KindSystem = KindSystem.Label,Language = language.en, Name = "sex",Layout = "infor"},
                 new SystemManagement() { ID = 208,FunctionID = "PI000105", ParentID = "PI000001", KindSystem = KindSystem.Label,Language = language.en, Name = "cic",Layout = "infor"},
                 new SystemManagement() { ID = 209,FunctionID = "PI000106", ParentID = "PI000001", KindSystem = KindSystem.Label,Language = language.en, Name = "address",Layout = "infor"},
                 new SystemManagement() { ID = 210,FunctionID = "PI000107", ParentID = "PI000001", KindSystem = KindSystem.Label,Language = language.en, Name = "account",Layout = "infor"},
                 new SystemManagement() { ID = 211,FunctionID = "PI000108", ParentID = "PI000001", KindSystem = KindSystem.Label,Language = language.en, Name = "password",Layout = "infor"},
                 new SystemManagement() { ID = 212,FunctionID = "PI000201", ParentID = "PI000002", KindSystem = KindSystem.Label,Language = language.en, Name = "name",Layout = "infor"},
                 new SystemManagement() { ID = 213,FunctionID = "PI000301", ParentID = "PI000003", KindSystem = KindSystem.Label,Language = language.en, Name = "name",Layout = "infor"}
                //profile-infor
