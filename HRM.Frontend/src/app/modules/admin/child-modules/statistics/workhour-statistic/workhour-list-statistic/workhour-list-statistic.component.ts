...
@Component({
  selector: 'workhour-list-statistic',
  templateUrl: './workhour-list-statistic.component.html',
 // styleUrls: ['../../../../../../../scss/shared/sreach.scss']
})
export class WorkhourListStatistic1Component implements OnInit {
  yearOptions: number[]=[];
  PageCount : number = 1
  searchText:any
  ...
  today: Date = new Date();
  dayinmonth:number=0
  daysInMonth = (year:any, month:any) => new Date(year, month, 0).getDate();
  items:any[]=[]
  ...
  ChangeData(day:any,requestpaing:RequestpagingStatistic ):void{
